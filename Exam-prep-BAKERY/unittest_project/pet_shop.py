...
# print(my_pet_shop.add_food("Bone", 500.0))
# print(my_pet_shop.add_food("Bone", 1.0))
# print(my_pet_shop.food)
# print(my_pet_shop.add_pet("Rex"))
# print(my_pet_shop.pets)
# print(my_pet_shop.add_pet("Silver"))
# print(my_pet_shop.pets)
# print(my_pet_shop.add_pet("Rex"))
# print(my_pet_shop.pets)
# print(my_pet_shop.feed_pet("Bone", "Rex"))
# print(my_pet_shop.feed_pet("Bone", "Fox"))