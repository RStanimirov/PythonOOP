...
# print(rs_report_card.grades_by_subject)

# print(rs_report_card.average_grade_by_subject())
#
# print(rs_report_card.average_grade_for_all_subjects())
#
# print(rs_report_card.__repr__())